...
context "#new" do
    ...
    context "when logged in" do
        ...
        should"display the friends name" do
            ...
            assert_match /#{users(:bill).full_name}/, response.body
        end
        ...
        should "assign a new user friendship to the correct friend" do
            get :new, friend_id: users(:bill)
            assert_equal users(:bill), assigns(:user_friendship).friend
        end

        should "assign a new user friendship to the currently logged in user" do
            get :new, friend_id: users(:bill)
            assert_equal users(:michael), assigns(:user_friendship).user
        end
      ...
      context "when not logged in" do
        ...
        context "when logged in" do
            ...
            should "assign a friend object" do
                ...
                assert_equal users(:bill), assigns(:friend)
            end
            ...
            should "create a friendship" do
              assert users(:michael).friends.include?(users(:bill))
            end

            should "redirect to the profile page of the friend" do
              assert_response :redirect
              assert_redirected_to profile_path(users(:bill))
            end
